...
// The source is cmd/coredhcp-generator/coredhcp.go.template; edit that and
// run `go generate ./...` here, or `make generate` from the repository root.
