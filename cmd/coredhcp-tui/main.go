...
// The source is cmd/coredhcp-generator/coredhcp-tui.go.template; edit that
// and run `go generate ./...` here, or `make generate` from the repository
// root. The generator lives in the parent module, which this one reaches
// through its replace directive.
