...
// # Placement
//
// The plugin does not end the chain, so a range6 or subnet listed after it
// adds a second IA_NA for the same IAID, which RFC 8415 does not allow: one
// pool plugin per chain.
package range6
